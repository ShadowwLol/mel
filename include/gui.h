...
device_init(struct device *dev)
{
	...
	dev->prog = MEL_str2shader(vertex_shader, fragment_shader);
	/* dev->prog = MEL_str2shader(vertex_shader, fragment_shader); */
...
device_draw(struct device *dev, struct nk_context *ctx, int width, int height,
    ...
    glUniformMatrix4fv(dev->uniform_proj, 1, GL_FALSE, &Rend.projection[0][0]);
    {
...
inline static void text_input(GLFWwindow *win, unsigned int codepoint)
{nk_input_unicode((struct nk_context*)glfwGetWindowUserPointer(win), codepoint);}
inline static void scroll_input(GLFWwindow *win, double _, double yoff)
