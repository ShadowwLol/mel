...
LINMATH_H_FUNC void mat4x4_invert(mat4x4 T, mat4x4 const M) {
  ...
  float idet =
    1.0f / (s[0] * c[5] - s[1] * c[4] + s[2] * c[3] + s[3] * c[2] -
            s[4] * c[1] + s[5] * c[0]);
...
LINMATH_H_FUNC void mat4x4_frustum(mat4x4 M, float l, float r, float b,
...
LINMATH_H_FUNC void mat4x4_look_at(mat4x4 m, vec3 const eye,
                                   vec3 const center, vec3 const up) {
