 ...
 * @param[out] dest destination vector
 */
CGLM_INLINE void glm_vec3_adds(vec3 v, float s, vec3 dest) {
  dest[0] = v[0] + s;
  dest[1] = v[1] + s;
  dest[2] = v[2] + s;
}
 ...
 * @param[out] dest destination vector
 */
CGLM_INLINE void glm_vec3_subs(vec3 v, float s, vec3 dest) {
  dest[0] = v[0] - s;
  dest[1] = v[1] - s;
  dest[2] = v[2] - s;
}
 ...
 */
CGLM_INLINE void glm_vec3_divs(vec3 v, float s, vec3 dest) {
  dest[0] = v[0] / s;
  dest[1] = v[1] / s;
  dest[2] = v[2] / s;
}
 ...
 * @param[out] dest destination
 */
CGLM_INLINE void glm_vec3_cross(vec3 a, vec3 b, vec3 dest) {
  vec3 c;
