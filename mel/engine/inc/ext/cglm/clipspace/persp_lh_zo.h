...
glm_perspective_lh_zo(float fovy,
                      float aspect, float nearZ, float farZ, mat4 dest) {
  float f, fn;
 ...
 */
CGLM_INLINE void glm_persp_move_far_lh_zo(mat4 proj, float deltaFar) {
 ...
 */
CGLM_INLINE void glm_persp_decompv_lh_zo(mat4 proj, float dest[6]) {
 ...
 */
CGLM_INLINE
  void glm_persp_decomp_near_lh_zo(mat4 proj, float* __restrict nearZ) {
 ...
 * @param[in] proj perspective projection matrix
 */
CGLM_INLINE float glm_persp_fovy_lh_zo(mat4 proj) {
 ...
 * @param[in] proj perspective projection matrix
 */
CGLM_INLINE float glm_persp_aspect_lh_zo(mat4 proj) {
