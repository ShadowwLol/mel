 ...
 */
CGLM_INLINE void glm_vec4_zero(vec4 v) {
#if defined( __SSE__ ) || defined( __SSE2__ )
 ...
 * @param[in, out]  v vector
 */
CGLM_INLINE void glm_vec4_one(vec4 v) {
#if defined( __SSE__ ) || defined( __SSE2__ )
...
CGLM_INLINE void glm_vec4_addadd(vec4 a, vec4 b, vec4 dest) {
  ...
  vst1q_f32(dest, vaddq_f32(vld1q_f32(dest),
                            vaddq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
  dest[2] += a[2] + b[2];
...
#elif defined(CGLM_NEON_FP)
  vst1q_f32(dest, vaddq_f32(vld1q_f32(dest),
                            vsubq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
  dest[2] += a[2] - b[2];
...
#elif defined(CGLM_NEON_FP)
  vst1q_f32(dest, vaddq_f32(vld1q_f32(dest),
                            vmaxq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
...
#elif defined(CGLM_NEON_FP)
  vst1q_f32(dest, vaddq_f32(vld1q_f32(dest),
                            vminq_f32(vld1q_f32(a), vld1q_f32(b))));
#else
 ...
 */
CGLM_INLINE void glm_vec4_negate_to(vec4 v, vec4 dest) {
#if defined( __SSE__ ) || defined( __SSE2__ )
 ...
 * @param[out] dest destination
 */
CGLM_INLINE void glm_vec4_normalize_to(vec4 v, vec4 dest) {
#if defined( __SSE__ ) || defined( __SSE2__ )
  __m128 xdot, x0;
  float dot;
 ...
 * @param[out]  dest destination
 */
CGLM_INLINE void glm_vec4_mix(vec4 from, vec4 to, float t, vec4 dest) {
 ...
 * @param[out]  dest destination
 */
CGLM_INLINE void glm_vec4_mixc(vec4 from, vec4 to, float t, vec4 dest) {
 ...
 * @param[out]  dest destination
 */
CGLM_INLINE void glm_vec4_cubic(float s, vec4 dest) {
  float ss;
