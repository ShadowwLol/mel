 ...
 */
CGLM_INLINE void glms_frustum_planes(mat4s m, vec4s dest[6]) {
  vec4 rawDest[6];
 ...
 */
CGLM_INLINE void glms_frustum_corners(mat4s invMat, vec4s dest[8]) {
  vec4 rawDest[8];
 ...
 */
CGLM_INLINE vec4s glms_frustum_center(vec4s corners[8]) {
  vec4 rawCorners[8];
  vec4s r;
 ...
 */
CGLM_INLINE void glms_frustum_box(vec4s corners[8], mat4s m, vec3s box[2]) {
  vec4 rawCorners[8];
  vec3 rawBox[2];
...
glms_frustum_corners_at(vec4s corners[8],
                        float splitDist,
                        float farDist, vec4s planeCorners[4]) {
  vec4 rawCorners[8];
