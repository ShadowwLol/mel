 ...
 * @returns matrix
 */
CGLM_INLINE mat2s glms_mat2_mul(mat2s m1, mat2s m2) {
  mat2s r;
 ...
 */
CGLM_INLINE mat2s glms_mat2_transpose(mat2s m) {
 ...
 */
CGLM_INLINE vec2s glms_mat2_mulv(mat2s m, vec2s v) {
  vec2s r;
 ...
 * @param[in]  m matrix
 */
CGLM_INLINE float glms_mat2_trace(mat2s m) {
 ...
 * @returns matrix
 */
CGLM_INLINE mat2s glms_mat2_scale(mat2s m, float s) {
 ...
 * @return determinant
 */
CGLM_INLINE float glms_mat2_det(mat2s mat) {
 ...
 * @returns matrix
 */
CGLM_INLINE mat2s glms_mat2_inv(mat2s mat) {
  mat2s r;
 ...
 * @returns matrix
 */
CGLM_INLINE mat2s glms_mat2_swap_col(mat2s mat, int col1, int col2) {
 ...
 * @returns matrix
 */
CGLM_INLINE mat2s glms_mat2_swap_row(mat2s mat, int row1, int row2) {
 ...
 */
CGLM_INLINE float glms_mat2_rmc(vec2s r, mat2s m, vec2s c) {
