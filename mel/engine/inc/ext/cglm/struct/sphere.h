 ...
 */
CGLM_INLINE float glms_sphere_radii(vec4s s) {
 ...
 */
CGLM_INLINE vec4s glms_sphere_transform(vec4s s, mat4s m) {
  vec4s r;
 ...
 */
CGLM_INLINE vec4s glms_sphere_merge(vec4s s1, vec4s s2) {
  vec4s r;
 ...
 */
CGLM_INLINE bool glms_sphere_sphere(vec4s s1, vec4s s2) {
 ...
 */
CGLM_INLINE bool glms_sphere_point(vec4s s, vec3s point) {
