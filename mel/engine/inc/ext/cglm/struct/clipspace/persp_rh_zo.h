 ...
 */
CGLM_INLINE mat4s glms_persp_move_far_rh_zo(mat4s proj, float deltaFar) {
  mat4s dest;
  dest = proj;
 ...
 * @param[in]      aspect aspect ratio ( width / height )
 */
CGLM_INLINE mat4s glms_perspective_resize_rh_zo(mat4s proj, float aspect) {
  mat4s dest;
  dest = proj;
 ...
 */
CGLM_INLINE
  void glms_persp_decomp_far_rh_zo(mat4s proj, float* __restrict farZ) {
 ...
 */
CGLM_INLINE
  void glms_persp_decomp_near_rh_zo(mat4s proj, float* __restrict nearZ) {
