 ...
 */
CGLM_INLINE vec3s glms_unprojecti(vec3s pos, mat4s invMat, vec4s vp) {
  vec3s r;
 ...
 * @returns             unprojected coordinates
 */
CGLM_INLINE vec3s glms_unproject(vec3s pos, mat4s m, vec4s vp) {
  vec3s r;
 ...
 */
CGLM_INLINE vec3s glms_project(vec3s pos, mat4s m, vec4s vp) {
  vec3s r;
 ...
 * @returns projected coordinates
 */
CGLM_INLINE mat4s glms_pickmatrix(vec2s center, vec2s size, vec4s vp) {
  mat4s res;
