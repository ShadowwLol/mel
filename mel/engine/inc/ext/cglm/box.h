 ...
 */
CGLM_INLINE void glm_aabb_transform(vec3 box[2], mat4 m, vec3 dest[2]) {
 ...
 */
CGLM_INLINE void glm_aabb_merge(vec3 box1[2], vec3 box2[2], vec3 dest[2]) {
 ...
 */
CGLM_INLINE void glm_aabb_crop(vec3 box[2], vec3 cropBox[2], vec3 dest[2]) {
...
glm_aabb_crop_until(vec3 box[2],
                    vec3 cropBox[2], vec3 clampBox[2], vec3 dest[2]) {
 ...
 */
CGLM_INLINE void glm_aabb_invalidate(vec3 box[2]) {
 ...
 * @param[in]  box bounding box
 */
CGLM_INLINE bool glm_aabb_isvalid(vec3 box[2]) {
 ...
 * @param[in]  box bounding box
 */
CGLM_INLINE float glm_aabb_size(vec3 box[2]) {
 ...
 * @param[in]  box bounding box
 */
CGLM_INLINE float glm_aabb_radius(vec3 box[2]) {
 ...
 */
CGLM_INLINE void glm_aabb_center(vec3 box[2], vec3 dest) {
 ...
 */
CGLM_INLINE bool glm_aabb_aabb(vec3 box[2], vec3 other[2]) {
 ...
 */
CGLM_INLINE bool glm_aabb_sphere(vec3 box[2], vec4 s) {
  float dmin;
  int a, b, c;
 ...
 */
CGLM_INLINE bool glm_aabb_point(vec3 box[2], vec3 point) {
 ...
 * @param[in]   other  other bounding box
 */
CGLM_INLINE bool glm_aabb_contains(vec3 box[2], vec3 other[2]) {
