 ...
 */
CGLM_INLINE void glm_quat_identity_array(versor * __restrict q, size_t count) {
  CGLM_ALIGN(16) versor v = GLM_QUAT_IDENTITY_INIT;
  size_t i;
 ...
 * @param[out]  dest  result quaternion
 */
CGLM_INLINE void glm_quat_nlerp(versor from, versor to, float t, versor dest) {
  versor target;
  float dot;
 ...
 * @param[out]  dest  result quaternion
 */
CGLM_INLINE void glm_quat_slerp(versor from, versor to, float t, versor dest) {
 ...
 * @param[out]  dest  destination quaternion
 */
CGLM_INLINE void glm_quat_for(vec3 dir, vec3 up, versor dest) {
 ...
 * @param[out]  dest  destination quaternion
 */
CGLM_INLINE void glm_quat_forp(vec3 from, vec3 to, vec3 up, versor dest) {
