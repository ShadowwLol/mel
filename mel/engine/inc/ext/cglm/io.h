...
CGLM_INLINE void glm_mat4_print(mat4 matrix, FILE * __restrict ostream) {
  char buff[16];
  int i, j, cw[4], cwi;
...
CGLM_INLINE void glm_mat3_print(mat3 matrix, FILE * __restrict ostream) {
  char buff[16];
  int i, j, cw[4], cwi;
...
CGLM_INLINE void glm_mat2_print(mat2 matrix, FILE * __restrict ostream) {
  char buff[16];
  int i, j, cw[4], cwi;
...
CGLM_INLINE void glm_vec4_print(vec4 vec, FILE * __restrict ostream) {
  int i;
...
CGLM_INLINE void glm_vec3_print(vec3 vec, FILE * __restrict ostream) {
  int i;
...
CGLM_INLINE void glm_ivec3_print(ivec3 vec, FILE * __restrict ostream) {
  int i;
...
CGLM_INLINE void glm_vec2_print(vec2 vec, FILE * __restrict ostream) {
  int i;
...
glm_aabb_print(vec3 bbox[2],
               const char* __restrict tag, FILE * __restrict ostream) {
  int i, j;
