...
static inline float32x4_t glmm_vhadd(float32x4_t v) {
...
static inline float32x4_t glmm_div(float32x4_t a, float32x4_t b) {
#if CGLM_ARM64
...
static inline
  float32x4_t glmm_fmadd(float32x4_t a, float32x4_t b, float32x4_t c) {
#if CGLM_ARM64
...
static inline
  float32x4_t glmm_fnmadd(float32x4_t a, float32x4_t b, float32x4_t c) {
#if CGLM_ARM64
...
static inline
  float32x4_t glmm_fmsub(float32x4_t a, float32x4_t b, float32x4_t c) {
#if CGLM_ARM64
  return vfmsq_f32(c, a, b);
#else
  return vmlsq_f32(c, a, b);
...
static inline
  float32x4_t glmm_fnmsub(float32x4_t a, float32x4_t b, float32x4_t c) {
