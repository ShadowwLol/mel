...
CGLM_INLINE void glm_mat4_scale_neon(mat4 m, float s) {
  float32x4_t v0;
...
CGLM_INLINE void glm_mat4_transp_neon(mat4 m, mat4 dest) {
  float32x4x4_t vmat;
...
CGLM_INLINE void glm_mat4_mul_neon(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_mat4_mulv_neon(mat4 m, vec4 v, vec4 dest) {
...
CGLM_INLINE float glm_mat4_det_neon(mat4 mat) {
  ...
  x2 = glmm_fmadd(vcombine_f32(vdup_lane_f32(gh, 0), gh),
                  vcombine_f32(vget_low_f32(a1.val[1]), vget_high_f32(x1)),
                  x2);
...
CGLM_INLINE void glm_mat4_inv_neon(mat4 mat, mat4 dest) {
  float32x4_t r0, r1, r2, r3,
    v0, v1, v2, v3,
    t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7, x8;
  float32x4x2_t a1;
  ...
  v0 =
    glmm_xor(glmm_fmadd(x3, t2, glmm_fnmadd(x2, t1, vmulq_f32(x1, t0))), x8);
  ...
  v2 =
    glmm_xor(glmm_fmadd(x3, t5, glmm_fnmadd(x1, t3, vmulq_f32(x0, t1))), x8);
  ...
  v1 =
    glmm_xor(glmm_fmadd(x3, t4, glmm_fnmadd(x2, t3, vmulq_f32(x0, t0))), x9);
  ...
  v3 =
    glmm_xor(glmm_fmadd(x2, t5, glmm_fnmadd(x1, t4, vmulq_f32(x0, t2))), x9);
