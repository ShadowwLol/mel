...
CGLM_INLINE void glm_mul_neon(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_mul_rot_neon(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_inv_tr_neon(mat4 mat) {
  float32x4x4_t vmat;
