...
CGLM_INLINE void glm_mat4_scale_sse2(mat4 m, float s) {
  __m128 x0;
  x0 = _mm_set1_ps(s);
...
CGLM_INLINE void glm_mat4_transp_sse2(mat4 m, mat4 dest) {
  __m128 r0, r1, r2, r3;
...
CGLM_INLINE void glm_mat4_mul_sse2(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_mat4_mulv_sse2(mat4 m, vec4 v, vec4 dest) {
...
CGLM_INLINE float glm_mat4_det_sse2(mat4 mat) {
  ...
  x2 = glmm_fnmadd(glmm_shuff1(r1, 1, 1, 2, 2), glmm_shuff1(x0, 3, 2, 2, 0),
                   _mm_mul_ps(glmm_shuff1(r1, 0, 0, 0, 1),
                              _mm_shuffle_ps(x1, x0,
                                             _MM_SHUFFLE(1, 0, 0, 0))));
  x2 =
    glmm_fmadd(glmm_shuff1(r1, 2, 3, 3, 3),
...
CGLM_INLINE void glm_mat4_inv_fast_sse2(mat4 mat, mat4 dest) {
  __m128 r0, r1, r2, r3,
    v0, v1, v2, v3,
    t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9;
...
CGLM_INLINE void glm_mat4_inv_sse2(mat4 mat, mat4 dest) {
  __m128 r0, r1, r2, r3,
    v0, v1, v2, v3,
    t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9;
