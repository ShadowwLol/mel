...
CGLM_INLINE void glm_mul_sse2(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_mul_rot_sse2(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
CGLM_INLINE void glm_inv_tr_sse2(mat4 mat) {
