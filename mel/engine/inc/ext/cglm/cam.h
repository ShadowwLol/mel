...
glm_frustum(float left, float right,
            float bottom, float top, float nearZ, float farZ, mat4 dest) {
#if CGLM_CONFIG_CLIP_CONTROL == CGLM_CLIP_CONTROL_LH_ZO
...
CGLM_INLINE
  void
glm_perspective(float fovy, float aspect, float nearZ, float farZ,
                mat4 dest) {
#if CGLM_CONFIG_CLIP_CONTROL == CGLM_CLIP_CONTROL_LH_ZO
 ...
 */
CGLM_INLINE void glm_persp_move_far(mat4 proj, float deltaFar) {
#if CGLM_CONFIG_CLIP_CONTROL == CGLM_CLIP_CONTROL_LH_ZO
...
CGLM_INLINE
  void
glm_persp_decomp_z(mat4 proj, float* __restrict nearZ,
 ...
 * @param[out] farZ   far
 */
CGLM_INLINE void glm_persp_decomp_far(mat4 proj, float* __restrict farZ) {
#if CGLM_CONFIG_CLIP_CONTROL == CGLM_CLIP_CONTROL_LH_ZO
 ...
 * @param[out] nearZ  near
 */
CGLM_INLINE void glm_persp_decomp_near(mat4 proj, float* __restrict nearZ) {
#if CGLM_CONFIG_CLIP_CONTROL == CGLM_CLIP_CONTROL_LH_ZO
