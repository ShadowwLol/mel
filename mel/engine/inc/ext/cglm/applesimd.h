...
*/
CGLM_INLINE simd_float4x4 glm_mat4_applesimd(mat4 m) {
  simd_float4x4 t;
...
*/
CGLM_INLINE simd_float3x3 glm_mat3_applesimd(mat3 m) {
  simd_float3x3 t;
...
* @return simd_float4
*/
CGLM_INLINE simd_float4 glm_vec4_applesimd(vec4 v) {
  return (simd_float4) {
  v[0], v[1], v[2], v[3]};
}
...
* @return v
*/
CGLM_INLINE simd_float3 glm_vec3_applesimd(vec3 v) {
  return (simd_float3) {
  v[0], v[1], v[2]};
}
