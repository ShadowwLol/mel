...
MEL_Renderer2D MEL_Renderer2D_ini(){
	...
	MEL_Renderer2D Renderer = {
		...
		.image_items.shader = shader_create_shader_program(IMAGE_VERT_SHADER_PATH, IMAGE_FRAG_SHADER_PATH),
		.image_items.indices = {
			0, 1, 3,
			1, 2, 3
		},
		/* Rectangle */
		.rect_items.shader = shader_create_shader_program(RECT_VERT_SHADER_PATH, RECT_FRAG_SHADER_PATH),
		.rect_items.indices = {
			0, 1, 3,
			1, 2, 3
		},
